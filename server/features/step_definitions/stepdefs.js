...
//Scenario 2: You should be able to log in to an existing user account
...
//Scenario 3: You should be not able to log in to a nonexistent user account
...
//Scenario 4: You can't create a user that already exists
